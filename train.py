...
if __name__ == '__main__':
	...
	# load normalized training and validation sets
	myprint("\nLoad the normalized training and validation set!", log)
	try:
		...
		myprint("The normalized datasets do not exist, please run normalization first.", log)
		exit(0)
